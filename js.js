...
var fruits = new Array("assets/elma.png", "assets/karpuz.png", "assets/hiyar.png", "assets/armut.png",
    "assets/nar.png", "assets/mandalina.png", "assets/portakal.png", "assets/muz.png");
var closePic = "assets/close.png";
var winPic = "assets/youwin.png";
var losePic = "assets/youlose.png";
var tableID;
var tablePic;
...
butonClickSound.src = "assets/ses1.mp3";
var loseSound = new Audio();
loseSound.src = "assets/ses2.mp3";
var winSound = new Audio();
winSound.src = "assets/ses3.mp3";
var closeSound;
...
function init() {
    ...
    if (gameOver) {
        ...
        backgroundGifChange('url(assets/myGif.gif)');
    }
...
function loseTheGame() {
    ...
    backgroundGifChange('url(assets/loseGif.gif)');
}
...
function winTheGame() {
    ...
    winSound.play();
    closeSound = winSound;
    backgroundGifChange('url(assets/winGif.gif)');
}
